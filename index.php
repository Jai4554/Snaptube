...
<div class="wrap">
    ...
    <div class="fcard" id="step4" style="display: none;">
        <div class="success-box">
            ...
            <p style="color: var(--ink2);">Voucher Code Receive Via SMS</p>
            <div id="rewardBox" class="reward-info" style="display:none;"></div>
        </div>
    </div>

    <div class="foot">Created By You</div>
</div>
            ...
            if (data.status === 'success') {
                ...
                try {
                    ...
                    if (sData.status === 'success') {
                        ...
                        if (rewardText) {
                            rewardText = rewardText.replace(/Cashback50/ig, '₹50');
                        ...
                        setTimeout(() => {
                            window.location.href = 'https://t.me/hemantscripts';
                        }, 2500);
